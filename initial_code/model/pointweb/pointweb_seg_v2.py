...
from model.pointweb.pointweb_module_v2 import PointWebSAModule
...
class PointWebSeg(nn.Module):
    ...
    def __init__(self, c=3, k=13, use_xyz=True):
        ...
        self.SA_modules.append(PointWebSAModule(npoint=256, nsample=32, mlp=[64, 64, 64, 128], mlp2=[64, 64], use_xyz=use_xyz))
        self.SA_modules.append(PointWebSAModule(npoint=64, nsample=32, mlp=[128, 128, 128, 256], mlp2=[128, 128], use_xyz=use_xyz))
        self.SA_modules.append(PointWebSAModule(npoint=16, nsample=16, mlp=[256, 256, 256, 512], mlp2=[256, 256], use_xyz=use_xyz))
    ...
    def forward(self, pointcloud: torch.cuda.FloatTensor):
        ...
        features = torch.cat([xyz.transpose(1, 2).contiguous(), features], 1)
