...
from model.pointnet2.pointnet2_modules_v2 import PointNet2SAModule, PointNet2SAModuleMSG
...
class PointNet2SSGCls(nn.Module):
    ...
    """
    def __init__(self, c=3, k=40, use_xyz=False):
        ...
        self.FC_layer = nn.Sequential(pt_util.FC(1024, 512, bn=True), pt_util.FC(512, 256, bn=True), pt_util.FC(256, k, activation=None))
