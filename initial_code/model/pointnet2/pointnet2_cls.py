...
class PointNet2SSGCls(nn.Module):
    ...
    def __init__(self, c=3, k=40, use_xyz=True):
        ...
        self.SA_modules.append(PointNet2SAModule(npoint=512, radius=0.2, nsample=32, mlp=[c, 64, 64, 128], use_xyz=use_xyz))
        self.SA_modules.append(PointNet2SAModule(npoint=128, radius=0.4, nsample=64, mlp=[128, 128, 128, 256], use_xyz=use_xyz))
