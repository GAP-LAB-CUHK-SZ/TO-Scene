...
class PointTransformerSeg(nn.Module):
    def __init__(self, block, blocks, c=6, k=13):
        ...
        self.bin1 = nn.Sequential(nn.Linear(planes[0], planes[0], bias=False), nn.BatchNorm1d(planes[0]), nn.ReLU(inplace=True))
    ...
    def forward(self, pxo):
        ...
        p_bin, x_bin, o_bin = self.enc_bin([p0, x0, o0])
        # use the intermediate result of bin1 as bin_vec, instead of max+to_cate+conv_bin 
        bin_vec = self.bin1(x_bin)
