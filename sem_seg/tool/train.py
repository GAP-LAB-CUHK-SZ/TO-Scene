...
from util.tovanilla_crowd import TOVanilla_Crowd
from util.toscannet import TOScanNet
...
def main():
    ...
    if args.data_name == 'tovanilla' or args.data_name == 'tocrowd':
        TOVanilla_Crowd(split='train', data_root=args.data_root, split_root=args.split_root)
        TOVanilla_Crowd(split='val', data_root=args.data_root, split_root=args.split_root)
    elif args.data_name == 'toscannet':
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if args.data_name == 'tovanilla' or args.data_name == 'tocrowd':
        train_data = TOVanilla_Crowd(split='train', data_root=args.data_root, split_root=args.split_root, voxel_size=args.voxel_size, voxel_max=args.voxel_max, transform=train_transform, shuffle_index=True, loop=args.loop, repeat_align=args.get('repeat', False))
    elif args.data_name == 'toscannet':
        train_data = TOScanNet(split='train', data_root=args.data_root, split_root=args.split_root, voxel_size=args.voxel_size, voxel_max=args.voxel_max, transform=train_transform, shuffle_index=True, loop=args.loop, repeat_align=args.get('repeat', False))
    ...
    if args.evaluate:
        val_transform = None
    if args.data_name == 'tovanilla' or args.data_name == 'tocrowd':
        train_data = TOVanilla_Crowd(split='val', data_root=args.data_root, split_root=args.split_root, voxel_size=args.voxel_size, voxel_max=800000, transform=val_transform)
    elif args.data_name == 'toscannet':
        train_data = TOScanNet(split='val', data_root=args.data_root, split_root=args.split_root, voxel_size=args.voxel_size, voxel_max=800000, transform=val_transform)
        if args.distributed:
